...
function PickTheSun() {
  return (
    <section className="">
      <div className="py-24 sm:py-20 flex flex-col items-center text-center">
        <span className="text-span-orange text-xl font-medium">
          No more waste
        </span>
        <h2 className="text-4xl font-bold sm:text-6xl sm:font-extrabold pt-2">
          Pick the Sun
        </h2>
      ...
      <div className="relative flex items-center justify-center w-full sm:px-4">
